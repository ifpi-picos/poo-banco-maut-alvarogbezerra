...
public class ContaCorrente extends Conta {
    private double chequeEspecial; // cheque especial deve ter um valor limite.
    ...
    // Decrementa em 10% caso o numero permitido de transações seja superior a 2 conforme o
    // requisito 9.
    ...
    public void getChequeEspecial() {
        System.out.println(
                "Você está usando o seguinte valor do cheque especial: " + this.chequeEspecial);
    }
